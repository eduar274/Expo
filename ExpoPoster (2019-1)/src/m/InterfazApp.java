...
public class InterfazApp extends JFrame implements ActionListener{
	...
	JLabel tit = new JLabel("Aprender Ingles");
	JButton bot1 = new JButton("Aprender");
	JButton bot2 = new JButton("Repasar");
	...
	private static File excel = new File("C:\\Users\\Eduar\\eclipse-workspace\\ExpoPoster (2019-1)\\files\\tabla.xlsx");
	...
	public InterfazApp() {
		...
		tit.setBounds(120, 10, 250, 40);
		tit.setFont(new Font(null, Font.ITALIC, 30));
		add(tit);
		setResizable(false);
		bot1.setBounds(60,300, 100, 30);
		bot1.addActionListener(this);
		add(bot1);
		bot2.addActionListener(this);
		bot2.setBounds(320, 300, 100, 30);
		add(bot2);
		bot3.setBounds(190, 400, 100, 30);
		bot3.addActionListener(this);
		add(bot3);
		ImageIcon pal=new ImageIcon("C:\\Users\\Eduar\\eclipse-workspace\\ExpoPoster (2019-1)\\files\\portada.png");
