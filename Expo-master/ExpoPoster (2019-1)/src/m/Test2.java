...
public class Test2 extends JFrame implements ActionListener {
	...
	static JButton obP = new JButton("Obtener Nueva Palabra/Get New Word");
	static JButton exit = new JButton("Salir/Exit1");
	...
	static JButton ver = new JButton("Verificar/Check");
	...
	Test2(){
		...
		JLabel frase1 = new JLabel("Escriba el significado de la palabra / Write the meaning of the word" + 
				" ");
		...
		exit.setBounds(160, 430, 120, 23);
		exit.addActionListener(this);
		contentPane.add(exit);  // ver 31, 400, 125, 23
		
		obP.setBounds(31, 400, 300, 23); //salir 270, 400, 200, 23
		obP.addActionListener(this);
		contentPane.add(obP);
		
		ver.setBounds(340, 400, 130, 23);// obp 160, 430, 120, 23
